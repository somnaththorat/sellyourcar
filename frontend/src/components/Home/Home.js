    ...
    <>
      ...
      <nav style={{ position: "sticky" }}>
        <NavLink to="/" className="icon">
          <span style={{ color: "red" }}>S</span>ell
          <span style={{ color: "red" }}>Y</span>our
          <span style={{ color: "red" }}>C</span>ar
        </NavLink>
        ...
        <ol>
          ...
          {loggedIn ? (
            <li>
              <NavLink to="/sellcar">SellCar</NavLink>
            </li>
          ) : (
            <li>
              <NavLink to="/login">SellCar</NavLink>
            </li>
          )}
          {loggedIn ? (
            <li>
